...
public class EventPool {
	...
	public static void initEventPool(){
		...
		newEvent.setOption2("["+ String.valueOf(newEvent.cost - 15) + " "+ Event.getTypeString(newEvent.getPenaltyType()) +"] Assign a Scientist to fix the problem. The fire will be resolved at no cost to resources.");
