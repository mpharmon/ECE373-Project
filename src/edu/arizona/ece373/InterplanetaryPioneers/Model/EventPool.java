...
public class EventPool {
	...
	public static void initEventPool(){
		 ...
		 * Instantiate Event 1
		 */
		Event event1 = new Event(Event.Low, true, GameData.parts, 25, 0.50, Person.engineer, true, false);
		//Set event text
		...
		event1.option2 = "["+ String.valueOf(event1.cost - 15) + " "+ Event.getTypeString(event1.getPenaltyType()) +"] Assign an Engineer to fix the problem. The power outtage will be resolved at a minimal cost to resources.";
		event1.option3 = "[5 - 25 "+ Event.getTypeString(event1.getPenaltyType()) +"] Assign your VIP to resolve the issue. Theres a chance your VIP will use less or more parts.";
	...
	public static Event getEvent(int select){
		return events.get(select);
	}
