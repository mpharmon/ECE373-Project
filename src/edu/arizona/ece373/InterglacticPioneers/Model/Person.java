...
public class Person {
	...
	public Boolean isVIP(){return ((this.skills & 1) > 0) ? true : false;}
	...
	public Boolean isPilot(){return ((this.skills & 2) > 0) ? true : false;}
	...
	public Boolean isCaptain(){return ((this.skills & 4) > 0) ? true : false;}
	...
	public Boolean isBotanist(){return ((this.skills & 8) > 0) ? true : false;}
	...
	public Boolean isDoctor(){return ((this.skills & 16 ) > 0) ? true : false;}
	...
	public Boolean isEngineer(){return ((this.skills & 32) > 0) ? true : false;}
	...
	public Boolean isScientist(){return ((this.skills & 64) > 0) ? true : false;}
