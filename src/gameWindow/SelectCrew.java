...
public class SelectCrew extends JFrame {
	...
	public SelectCrew() {
		...
		comboBox.setModel(new DefaultComboBoxModel<Object>(new String[] {"Pilot", "Engineer", "Scientist", "Botanist", "Doctor"}));
		comboBox.setSelectedIndex(0);
		comboBox.setBounds(983, 196, 116, 25);
		contentPane.add(comboBox);
		
		JComboBox comboBox_1 = new JComboBox();
		comboBox_1.setModel(new DefaultComboBoxModel<Object>(new String[] {"Pilot", "Engineer", "Scientist", "Botanist", "Doctor"}));
		...
		comboBox_2.setModel(new DefaultComboBoxModel<Object>(new String[] {"Pilot", "Engineer", "Scientist", "Botanist", "Doctor"}));
		...
		comboBox_3.setModel(new DefaultComboBoxModel<Object>(new String[] {"Pilot", "Engineer", "Scientist", "Botanist", "Doctor"}));
		...
		comboBox_4.setModel(new DefaultComboBoxModel<Object>(new String[] {"Pilot", "Engineer", "Scientist", "Botanist", "Doctor"}));
