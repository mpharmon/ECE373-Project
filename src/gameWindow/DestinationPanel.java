...
public class DestinationPanel extends JPanel {
	...
	public DestinationPanel() {
		...
		lblDestination.setIcon(new ImageIcon(DestinationPanel.class.getResource("/images/spacexEuropaFIT.jpg")));
		...
		lblBackground.setIcon(new ImageIcon(DestinationPanel.class.getResource("/images/hud_bg_full.jpg")));
	...
	public void displayDestination(GameData gameData){
		...
		if(Destination.getId() == Destination.MARS){
			if(gameData.getSpacecraft().getId() == Spaceship.ORION_CAPSULE){
				lblDestination.setIcon(new ImageIcon(DestinationPanel.class.getResource("/images/ColonistsMarsFIT.png")));
				lblDestination.setBounds(120, 70, 1084, 463);
			}else{
				lblDestination.setIcon(new ImageIcon(DestinationPanel.class.getResource("/images/SpaceXmarsFIT3.jpg")));
