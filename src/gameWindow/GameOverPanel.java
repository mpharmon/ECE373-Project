...
public class GameOverPanel extends JPanel {
	...
	public GameOverPanel() {
		...
		lblGameOverImage.setIcon(new ImageIcon(GameOverPanel.class.getResource("/images/gameOver.jpg")));
		...
		lblBackground.setIcon(new ImageIcon(GameOverPanel.class.getResource("/images/gameOverHud.jpg")));
